    ...
    var section = '<ul id="'+name+'-description" class="collection with-header"><li class="collection-header"><h5>Description</h5></li><li class="collection-item">'+ escape(object.description) +'</li></ul>'+
                  ...
                  if (results) {
                    ...
                    for (var key in results) {
                      section += '<li>' +
                                    '<div class="collapsible-header"><strong>'+ key +'</strong></div>' +
...
var progressiveTab = '<h3>Progressive Audit1</h3>' + createSection(progressiveWebApp, 'progressive');
var progressiveSideBar = createSidebar('progressive');

var performanceTab = '<h3>Performance Audit1</h3>' + createSection(performanceObj, 'performance');
var performanceSideBar = createSidebar('performance');

var accessibilityTab = '<h3>Accessibility Audit1</h3>' + createSection(accessibilityObj, 'accessibility');
var accessibilitySideBar = createSidebar('accessibility');

var practicesTab = '<h3>Best Practice Audit1</h3>' + createSection(bestPracticesObj, 'bestpractice');
